...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
        ...
        String str[] = {"Front Desk Clerks","Forters","Housekeeping","Room Service","Waiters/Waitress","Manager","Accountant","chef"};
        ...
        l1.setBounds(380,70,450,450);
        add(l1);
        
        JLabel l2 = new JLabel("ADD EMPLOYEE DETAIL");
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        String str = "insert into employee values('"+name+"','"+age+"','"+gender+"','"+job+"','"+sal+"','"+phone+"','"+aadhar+"','"+email+"')";
        
        try{
            c.s.executeUpdate(str);
            JOptionPane.showMessageDialog(null, "Now Employee Added");
